'use client';
import { SignIn, useUser, SignedOut } from '@clerk/nextjs'
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-royal-50 to-royal-100 p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-royal-800 mb-2">Welcome to Typemeet</h1>
            <p className="text-royal-600">Sign in to your account</p>
          </div>
          <SignIn 
            appearance={{
              elements: {
